...
module loopback_testbench_v_tf();
  ...
  // and reset signals.  The clock should be changed to 100 MHz, and
  ...
  begin
    ...
    CYCLE_WAIT(1000);
    // Apply 1st pattern to the switches and then check
    ...
    // Apply 2nd pattern to the switches and then check
    // that it appears on the LEDs after a short time.
